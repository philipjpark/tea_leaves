...
const TokenLaunch: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'tea-leaves token holders can participate in platform governance and strategy voting.',
  ...
  return (
        ...
        sx={{
          py: 8,
          background: 'linear-gradient(45deg, rgba(106, 27, 154, 0.05) 30%, rgba(74, 20, 140, 0.05) 90%)',
          position: 'relative',
          overflow: 'hidden'
        }}
      >
                    ...
                    <Card
                      sx={{
                        ...
                        '&::before': {
                          ...
                          right: 0,
                          bottom: 0,
                          background: 'linear-gradient(45deg, rgba(106, 27, 154, 0.1) 30%, rgba(74, 20, 140, 0.1) 90%)',
                          zIndex: 0
                        },
                        '&:hover': {
